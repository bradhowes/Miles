...
public class Sequence {
    ...
    public init(engine: AVAudioEngine, harmonization: Harmonization, tempo: Double = 120, withInstruments instruments: [Instrument]) {
    ...
    public func setDrawingCanvas(_ canvas: MilesCanvas) {
        ...
        instruments.forEach { $0.canvas = canvas }
    }
}
