...
public struct Harmonization {
    ...
    public enum HarmonizationType {
        ...
        public var scale: Scale {
            ...
            case .melodicMinor: return .minorMelodic
            case .harmonicMinor: return .minorHarmonic
            }
        }
    }
    ...
    public init(key: Tone, type: HarmonizationType) {
        ...
        // self.chords = scaleTones.count == type.chordQualities.count ? zip(scaleTones, chordQualities).map { Chord(root: $0, quality: $1) } : []
        self.chords = zip(scaleTones, chordQualities).map { Chord(root: $0, quality: $1) }
    }
}
